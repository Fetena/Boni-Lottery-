...
class MainAdminLotteryDraw {
    ...
    async init() {
        ...
        // Default datetime inputs if empty
    ...
    async loadPastWinners() {
        ...
        try {
            ...
            snapshot.forEach(doc => {
                ...
                // Filter for history staying within 1 week (7 days)
            ...
            const spinInterval = setInterval(() => {
                ...
                if (spinCount >= maxSpins) {
                    ...
                    db.collection('lottery_draws').add({
                        ...
                        // Refresh history feed instantly
...
}l rounded-2xl p-6 border-2 border-yellow-400/40 bg-gradient-to-b from-yellow-400/10 to-black space-y-4 text-center shadow-[0_0_25px_rgba(252,211,77,0.15)]">
                <div>
                    <span class="bg-yellow-400/20 text-yellow-300 border border-yellow-400/30 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">⚡ Live Draw Center</span>
